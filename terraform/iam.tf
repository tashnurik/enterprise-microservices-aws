...
# Custom policy for ECS to access Secrets Manager
...
# OIDC Provider for EKS (needed for External Secrets Operator)
...
# Policy for External Secrets Operator to access Secrets Manager
